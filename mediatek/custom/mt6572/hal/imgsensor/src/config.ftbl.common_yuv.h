...
FTABLE_SCENE_INDEP()
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
		//modify add size "720x432","768x432" by zhaolong
                "320x240",      "640x480",      "720x432",      "768x432",      "1024x768",     
                "1280x720",     "1280x768",     "1280x960",     "1600x960",     "1600x1200",
		//modify BUG_ID:DLELTCLW-7 zhaolong 20130619 (start)
                "2048x1536",    "2560x1440",    "2560x1920",    "2880x1728",
		//modify BUG_ID:DLELTCLW-7 zhaolong 20130619 (end)     
            )
        ), 
    )
#endif
    ...
    FTABLE_CONFIG_AS_TYPE_OF_USER(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_("0"), 
            ITEM_AS_USER_LIST_(
		//modify BUG_ID:DELB-327 zhaolong 20130701 (start)
                //"-1",       //min exposure compensation index
                //"1",        //max exposure compensation index
		"-2",
                "2",
		//modify BUG_ID:DELB-327 zhaolong 20130701 (end)
