...
extern "C"
{
    ...
    const TCFG_FILE g_akCFG_File_Custom[]=
    {
	 ...
	 //DELL-1046  add by silongjun 20130617  begin
         {                                                                                        
		"/data/nvram/APCFG/APRDEB/NEW_PRODUCT_INFO" , VER(AP_CFG_REEB_PRODUCT_NEW_INFO_LID), CFG_FILE_REEB_NEW_REC_SIZE,
		CFG_FILE_REEB_NEW_REC_TOTAL,                SIGNLE_DEFUALT_REC,                                    (char*)& NewProdStruct,   DataReset ,NULL   	

          }, 
			
	//DELL-1046 add by silongjun 20130617  end
