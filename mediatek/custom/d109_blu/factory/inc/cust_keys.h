/************************************************************************
History:
2. chuiguo.zeng@ragentek.com 2013.04.12 BUG_ID:None
   Description: Add menu key,center key and back key into test scene.
1. chuiguo.zeng@ragentek.com 2013.03.11 BUG_ID:MDWLYBLU-196 
   Description: Fix the problem that the back key was mapped as volume up key, the volume up key was mapped as back key.
************************************************************************/
...
//modify BUG_ID:None zengchuiguo 20130412 (start)
//#define KEYS_PWRKEY_MAP		{ KEY_ENDCALL, "PwrEnd" }
#define KEYS_PWRKEY_MAP		{ KEY_POWER, "Power" }
//modify BUG_ID:None zengchuiguo 20130412 (end)
...
//modify BUG_ID:MDWLYBLU-196 zengchuiguo 20130312 (start)
//#define CUST_KEY_VOLUP		KEY_BACK
#define CUST_KEY_VOLUP		KEY_VOLUMEUP
//modify BUG_ID:MDWLYBLU-196 zengchuiguo 20130312 (end)
