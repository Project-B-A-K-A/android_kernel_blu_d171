...
#if defined (APK_UPDATE) ||defined (AUTO_UPGRADE) || defined (NODE_UPGRADE) 

#if defined (AUTO_UPGRADE) || defined (NODE_UPGRADE)
static unsigned char CTPM_FW_D206_DJ_48_10040_0336A[] = {
	#include "D206_DJ_48_10040_0336A_00_V2.42.i"
};
...
static unsigned char CTPM_FW_D208_FN_CS040X_RT04[] = {
	#include "D208_FN_CS040X-RT04_C1_43.i"
};
...
int msg_ctpm_auto_upgrade(struct i2c_client *client)
{
	...
	{
		get_i_file_info(CTPM_FW_D206_DJ_48_10040_0336A, sizeof(CTPM_FW_D206_DJ_48_10040_0336A), &tp_i_file_major, &tp_i_file_minor);
	...
	//end 
	{
		if (tp_ic_major == DIJIN_FW_MAJOR)
		{
			size = sizeof(CTPM_FW_D206_DJ_48_10040_0336A);
...
DiJin TP [D206][48-10040-0336A][firmware:0x42,major:0x2,minor:0x42]----1\n\n\
DiJin TP [D208][48-10040-0359A][firmware:0x42,major:0x2,minor:0x42]----2\n\n\
FuNa  TP [D206][CS040X_RT01]   [firmware:0x33,major:0x1,minor:0x33]----3\n\n\
FuNa  TP [D208][CS040X_RT04]   [firmware:0x43,major:0x1,minor:0x43]----4\n\n\ 
Truly TP [D208][TRULY_CP1F0471][firmware:0x32,major:0x4,minor:0x32]----5\n\n\ 
########################################\n\
...
static int touch_event_handler(void *unused)
{
    ...
    do
    {
        ...
        if(tpd_touchinfo(&cinfo))
        {
            ...
            if(point_num == 1)
            {
               SSL_PRINT("msg2133: x=%d, y=%d\n ",cinfo.x[0],cinfo.y[0]);//add by lisong
