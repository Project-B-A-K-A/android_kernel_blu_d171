...
#include "gc2035plyuv_Sensor.h"
#include "gc2035plyuv_Camera_Sensor_para.h"
#include "gc2035plyuv_CameraCustomized.h"
...
Gc2035Status Gc2035CurrentStatus;

static DEFINE_SPINLOCK(gc2035yuv_drv_lock);
...
static void GC2035InitialPara(void)
{
  /*Initial status setting 
  Can be better by sync with MT9V114InitialSetting*/
  spin_lock(&gc2035yuv_drv_lock);
  Gc2035CurrentStatus.iNightMode = 0xFFFF;
  Gc2035CurrentStatus.iWB = AWB_MODE_AUTO;
  Gc2035CurrentStatus.iEffect = MEFFECT_OFF;
  Gc2035CurrentStatus.iBanding = AE_FLICKER_MODE_50HZ;
  Gc2035CurrentStatus.iEV = AE_EV_COMP_n03;
  Gc2035CurrentStatus.iMirror = IMAGE_NORMAL;
  Gc2035CurrentStatus.iFrameRate = 0;//No Fix FrameRate
  spin_unlock(&gc2035yuv_drv_lock);
}


void Gc2035GetExifInfo(UINT32 exifAddr)
{
    SENSOR_EXIF_INFO_STRUCT* pExifInfo = (SENSOR_EXIF_INFO_STRUCT*)exifAddr;
    pExifInfo->FNumber = 28;
    pExifInfo->AEISOSpeed = AE_ISO_100;
    pExifInfo->AWBMode = Gc2035CurrentStatus.iWB;
...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0xae , 0x82); 
	GC2035_write_cmos_sensor(0xaf , 0x84); 
	///////////analog/////////////
...
#if defined(PROJECT_CUSTOMER_J221) || defined(PROJECT_CUSTOMER_D109)|| defined(PROJECT_CUSTOMER_J202)
	GC2035_write_cmos_sensor(0x17 , 0x14); //[0]mirror [1]flip
	printk("\nsym J221\n");
	#else
	GC2035_write_cmos_sensor(0x17 , 0x17); //[0]mirror [1]flip
	#endif
	...
	GC2035_write_cmos_sensor(0x24 , 0x13); //pad drive  16//17
	...
	GC2035_write_cmos_sensor(0x13 , 0x70);//y_target
	GC2035_write_cmos_sensor(0xfe , 0x00);
	...
	GC2035_write_cmos_sensor(0x86 , 0x82); //02 //sync plority 
	...
	////Record date: 2013-07-03 11:19:02

	GC2035_write_cmos_sensor(0xfe, 0x01);
	GC2035_write_cmos_sensor(0xc2, 0x22);
	GC2035_write_cmos_sensor(0xc3, 0x22);
	...
	GC2035_write_cmos_sensor(0xbc, 0x44);
	GC2035_write_cmos_sensor(0xbd, 0x30);// 2f
	GC2035_write_cmos_sensor(0xbe, 0x36);
	GC2035_write_cmos_sensor(0xb6, 0x3d);
	GC2035_write_cmos_sensor(0xb7, 0x3b);// 38
	GC2035_write_cmos_sensor(0xb8, 0x2e);
	GC2035_write_cmos_sensor(0xc5, 0x1b);
	GC2035_write_cmos_sensor(0xc6, 0x26);
	GC2035_write_cmos_sensor(0xc7, 0x2f);
	GC2035_write_cmos_sensor(0xcb, 0x38);
	GC2035_write_cmos_sensor(0xcc, 0x19);
	GC2035_write_cmos_sensor(0xcd, 0x17);
	GC2035_write_cmos_sensor(0xbf, 0x26);
	GC2035_write_cmos_sensor(0xc0, 0x1d);
	GC2035_write_cmos_sensor(0xc1, 0x33);// 2d
	GC2035_write_cmos_sensor(0xb9, 0x1b);// 1a
	GC2035_write_cmos_sensor(0xba, 0x21);
	GC2035_write_cmos_sensor(0xbb, 0x18);
	GC2035_write_cmos_sensor(0xaa, 0x00);
	GC2035_write_cmos_sensor(0xab, 0x08);
	GC2035_write_cmos_sensor(0xac, 0x06);
	GC2035_write_cmos_sensor(0xad, 0x00);
	GC2035_write_cmos_sensor(0xae, 0x02);
	GC2035_write_cmos_sensor(0xaf, 0x0d);
	GC2035_write_cmos_sensor(0xb0, 0x0b);
	GC2035_write_cmos_sensor(0xb1, 0x0a);
	GC2035_write_cmos_sensor(0xb2, 0x00);
	GC2035_write_cmos_sensor(0xb3, 0x06);
	GC2035_write_cmos_sensor(0xb4, 0x10);
	GC2035_write_cmos_sensor(0xb5, 0x06);
	GC2035_write_cmos_sensor(0xd0, 0x7a);
	GC2035_write_cmos_sensor(0xd2, 0x5e);
	GC2035_write_cmos_sensor(0xd3, 0x59);
	GC2035_write_cmos_sensor(0xd8, 0x3d);
	GC2035_write_cmos_sensor(0xda, 0x34);
	GC2035_write_cmos_sensor(0xdb, 0x0b);
	GC2035_write_cmos_sensor(0xdc, 0x00);
	GC2035_write_cmos_sensor(0xde, 0x00);
	GC2035_write_cmos_sensor(0xdf, 0x08);
	GC2035_write_cmos_sensor(0xd4, 0x1c);
	GC2035_write_cmos_sensor(0xd6, 0x00);
	GC2035_write_cmos_sensor(0xd7, 0x17);
	...
	GC2035_write_cmos_sensor(0x4f , 0x00);
	#if 0
	GC2035_write_cmos_sensor(0x4d , 0x35); ///////////30           
 	GC2035_write_cmos_sensor(0x4e , 0x00);//02                 
 	GC2035_write_cmos_sensor(0x4e , 0x02); 
	GC2035_write_cmos_sensor(0x4d , 0x43); ///////////40           
 	GC2035_write_cmos_sensor(0x4e , 0x00);  //08               
	...
	GC2035_write_cmos_sensor(0x4d , 0x52); ///////////50           
 	...
 	GC2035_write_cmos_sensor(0x4e , 0x20);
	GC2035_write_cmos_sensor(0x4d , 0xa2); ///////////a0           
 	GC2035_write_cmos_sensor(0x4e , 0x40);     
 	GC2035_write_cmos_sensor(0x4e , 0x40);
	GC2035_write_cmos_sensor(0x4f , 0x01);
 	#else
 	GC2035_write_cmos_sensor(0x4d , 0x31); ///////////30           
 	GC2035_write_cmos_sensor(0x4e , 0x80);//02                 
 	GC2035_write_cmos_sensor(0x4e , 0x80); 
 	GC2035_write_cmos_sensor(0x4e , 0x02); 
 	GC2035_write_cmos_sensor(0x4e , 0x02); 
	GC2035_write_cmos_sensor(0x4d , 0x43); ///////////40           
 	GC2035_write_cmos_sensor(0x4e , 0x08);  //08               
 	GC2035_write_cmos_sensor(0x4e , 0x04); 
 	GC2035_write_cmos_sensor(0x4e , 0x00);                 
 	GC2035_write_cmos_sensor(0x4e , 0x02); 
 	GC2035_write_cmos_sensor(0x4e , 0x00); 
	GC2035_write_cmos_sensor(0x4d , 0x53); ///////////50           
 	GC2035_write_cmos_sensor(0x4e , 0x10);  //08               
 	GC2035_write_cmos_sensor(0x4e , 0x04); //08  
 	GC2035_write_cmos_sensor(0x4d , 0x72); ///////////60           
 	GC2035_write_cmos_sensor(0x4e , 0x20);    
	GC2035_write_cmos_sensor(0x4f , 0x01);
 	#endif               
	...
	GC2035_write_cmos_sensor(0x56, 0x0e);//00  
	GC2035_write_cmos_sensor(0x57 , 0x20); //pre adjust
	GC2035_write_cmos_sensor(0x58 , 0x01); 
	GC2035_write_cmos_sensor(0x5b , 0x08); //AWB_gain_delta
	...
	GC2035_write_cmos_sensor(0x72 , 0x25);
	...
	GC2035_write_cmos_sensor(0xa7 , 0x60); //ot_th 80
	...
	GC2035_write_cmos_sensor(0xb3 , 0x60); //saturation dec slope  80
	GC2035_write_cmos_sensor(0xde , 0xb2);  //
	...
	////////////YCP//////////
	GC2035_write_cmos_sensor(0xd1 , 0x32);//saturation_cb  36 // 0X34  0704
	GC2035_write_cmos_sensor(0xd2 , 0x32);//saturation_Cr	// 0X34  0704
	GC2035_write_cmos_sensor(0xd3 , 0x40);//contrast ? 44	
        GC2035_write_cmos_sensor(0xd4 , 0x80);//contrast center 
	GC2035_write_cmos_sensor(0xd5 , 0x00);//luma_offset 00
	GC2035_write_cmos_sensor(0xdc , 0x30);
	GC2035_write_cmos_sensor(0xdd , 0xb8);//edge_sa_g,b
	GC2035_write_cmos_sensor(0xfe , 0x00);
	///////dndd///////////
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x88 , 0x1c);//dn_b_base  08
	GC2035_write_cmos_sensor(0x8c , 0xf6); //[2]b_in_dark_inc
	GC2035_write_cmos_sensor(0x89 , 0x02); //dn_c_weight  03
	////////EE ///////////
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x90 , 0x6c);// EEINTP mode1
	GC2035_write_cmos_sensor(0x97 , 0x45);// edge effect//45   69
	////==============RGB Gamma 
	GC2035_write_cmos_sensor(0xfe , 0x02);
...
BOOL GC2035_set_param_wb(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AWB_MODE_CLOUDY_DAYLIGHT: //cloudy   
			...
			GC2035_write_cmos_sensor(0xb3, 0x70);  //0x58
			GC2035_write_cmos_sensor(0xb4, 0x40);
...
BOOL GC2035_set_param_exposure(UINT16 para)
{
	...
	printk("sym para=%d, 0x13=0x%x\n",para,GC2035_read_cmos_sensor(0x13));
...
case AE_EV_COMP_00:
GC2035_SET_PAGE1;
GC2035_write_cmos_sensor(0x13,0x70);//88
GC2035_SET_PAGE0;
break;
/* case AE_EV_COMP_03:
GC2035_SET_PAGE1;
...
return FALSE;
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x8c);
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_03:
			GC2035_SET_PAGE1;
							 ...
							 UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	switch (FeatureId)
	{
		...
		case SENSOR_FEATURE_GET_EXIF_INFO:
			...
			Gc2035GetExifInfo(*pFeatureData32);
			break;
		default:
			break;			
	}
