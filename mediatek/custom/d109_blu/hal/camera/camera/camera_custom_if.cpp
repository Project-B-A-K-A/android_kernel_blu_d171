...
* custom exif
*******************************************************************************/
//modify BUG_ID:DYLJ-121 zhaolong 20130723 (start)
#define EN_CUSTOM_EXIF_INFO
//modify BUG_ID:DYLJ-121 zhaolong 20130723 (end)
MINT32 custom_SetExif(void **ppCustomExifTag)
{
#ifdef EN_CUSTOM_EXIF_INFO
//modify BUG_ID:DYLJ-121 zhaolong 20130723 (start)
#define CUSTOM_EXIF_STRING_MAKE  "BLU"
#define CUSTOM_EXIF_STRING_MODEL "BLU DASH 3.5"
//modify BUG_ID:DYLJ-121 zhaolong 20130723 (end)
