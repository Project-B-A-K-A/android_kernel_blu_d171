...
#if 1
#define SENSOR_DRVNAME_GC2035_PL_YUV   "gc2035pl.yuv"
...
FTABLE_SCENE_INDEP()
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
        ITEM_AS_DEFAULT_("2048x1536"), 
        //    ITEM_AS_DEFAULT_("2048x1536"), 
            ITEM_AS_VALUES_(
                "320x240",      "640x480",      "1024x768",     "1280x720",     "1280x768",     "1280x960", 
                "1600x960",     "1600x1200",    "2048x1536",    "2240x1344",    
            )
        ), 
    )
#endif
...
//                MtkCameraParameters::ANTIBANDING_AUTO, 
    ...
    FTABLE_CONFIG_AS_TYPE_OF_USER(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_(MtkCameraParameters::TRUE), //modify BUG_ID: JEEY-173 default false  by zhaolong
        ), 
    )
#endif
    //==========================================================================
