/*********************
History:
1.zhaolong@ragentek  20130515  BUG_ID:DELB-58 
  Description: add picture size "1600x960" and "2880x1728" in full screen.
*********************/
...
#if 1
//#define SENSOR_DRVNAME_GC2035_PL_YUV   "common.yuv"


/*******************************************************************************
 *
 ******************************************************************************/
FTABLE_DEFINITION(SENSOR_DRVNAME_GC2035_PL_YUV)
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
FTABLE_SCENE_INDEP()
    //==========================================================================
#if 1
...
//                MtkCameraParameters::ANTIBANDING_AUTO, 
    ...
    FTABLE_CONFIG_AS_TYPE_OF_USER(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_(MtkCameraParameters::TRUE), //modify BUG_ID: JELY-173 default false  by zhaolong
        ), 
    )
#endif
    //==========================================================================
