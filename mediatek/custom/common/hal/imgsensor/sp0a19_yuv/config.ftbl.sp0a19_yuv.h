 ...
 *
 ******************************************************************************/
FTABLE_DEFINITION(SENSOR_DRVNAME_SP0A19_YUV)
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
FTABLE_SCENE_INDEP()
    //==========================================================================
#if 1
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
		//modify picture size support 0.3M by zhaolong (start)
                //"320x240",      "640x480",      "1024x768",     "1280x720",     "1280x768",     "1280x960", 
		"320x240",      "640x480",      "720x432",     "768x432",
		//modify picture size support 0.3M by zhaolong (end)
            )
        ), 
    )
#endif
