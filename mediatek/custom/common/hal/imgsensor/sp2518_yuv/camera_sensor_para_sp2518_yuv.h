#ifndef _CAMERA_SENSOR_PARA_SP2518_YUV_H
#define _CAMERA_SENSOR_PARA_SP2518_YUV_H
...
typedef enum
{
	...
	/* STRUCT: SENSOR */
#define SP2518_YUV_CAMERA_SENSOR_REG_DEFAULT_VALUE \
		/* ARRAY: SENSOR.reg[11] */\
		{\
			/* STRUCT: SENSOR.reg[0] */\
			{\
...
#define SP2518_YUV_CAMERA_SENSOR_CCT_DEFAULT_VALUE {{0x30a1,0x00},{0x3000,0x1B}}


#endif//#ifndef _CAMERA_SENSOR_PARA_SP2518_YUV_H
