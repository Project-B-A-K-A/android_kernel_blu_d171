...
extern LCM_DRIVER otm8018b_dsi_vdo_djn_lcm_drv;	 	 // zhoulidong add
extern LCM_DRIVER otm8018b_dsi_vdo_djn_md215_lcm_drv;	 	 // zhoulidong add
extern LCM_DRIVER otm8018b_dsi_vdo_azet_md215_lcm_drv;	 	 // zhoulidong add
extern LCM_DRIVER ili9806c_dsi_vdo_djn_lcm_drv;	 	 // zhoulidong add
extern LCM_DRIVER ili9806c_dsi_vdo_qj_lcm_drv;	 	 // zhoulidong add
extern LCM_DRIVER otm8018b_dsi_vdo_truly_lcm_drv;	  // zhoulidong add
extern LCM_DRIVER otm8018b_dsi_vdo_trust_lcm_drv;	  // zhoulidong add
extern LCM_DRIVER ili9806c_dsi_vdo_txd_lcm_drv;	 	 // zhoulidong add
extern LCM_DRIVER ili9806c_dsi_vdo_txd_j202_lcm_drv;	 	 // zhoulidong add
extern LCM_DRIVER ili9806c_dsi_vdo_djn_fwvga_lcm_drv;	 	 // zhoulidong add
extern LCM_DRIVER nt35310_dsi_cmd_djn_hvga_lcm_drv;	 	 // zhoulidong add
extern LCM_DRIVER ili9488_dsi_vdo_azet_hvga_lcm_drv;	 	 // zhoulidong add
extern LCM_DRIVER otm8018b_dsi_vdo_txd_fwvga_lcm_drv;   // zhoulidong add
extern LCM_DRIVER ili9806c_dsi_vdo_azet_ips_lcm_drv;   // zhoulidong add
...
#if defined(ILI9806C_DSI_VDO_TXD_J202)	
	&ili9806c_dsi_vdo_txd_j202_lcm_drv, 
#endif

#if defined(ILI9806C_DSI_VDO_QJ)	
	&ili9806c_dsi_vdo_qj_lcm_drv, 
#endif
...
#if defined(OTM8018B_DSI_VDO_AZET_MD215)	
	&otm8018b_dsi_vdo_azet_md215_lcm_drv, 
#endif
...
#if defined(NT35310_DSI_CMD_DJN_HVGA)	
	&nt35310_dsi_cmd_djn_hvga_lcm_drv, 
#endif

#if defined(ILI9488_DSI_VDO_AZET_HVGA)	
	&ili9488_dsi_vdo_azet_hvga_lcm_drv, 
#endif
