...
int msg_ctpm_auto_upgrade(struct i2c_client *client)
{
	...
	{
		get_i_file_info(CTPM_FW_D208_DJ_S2_0374A, sizeof(CTPM_FW_D208_DJ_S2_0374A), &tp_i_file_major, &tp_i_file_minor);
	...
	//end 
	{
		if (tp_ic_major == DIJIN_FW_MAJOR)
		{
			size = sizeof(CTPM_FW_D208_DJ_S2_0374A);
...
DiJin TP [D206]   [48-10040-0336A][firmware:0x44,major:0x2,minor:0x44]----1\n\n\
DiJin TP [D208]   [48-10040-0359A][firmware:0x44,major:0x2,minor:0x44]----2\n\n\
DiJin TP [D208-S2][0374A]         [firmware:0x45,major:0x2,minor:0x45]----3\n\n\
FuNa  TP [D206]   [CS040X_RT01]   [firmware:0x33,major:0x1,minor:0x33]----4\n\n\
FuNa  TP [D208]   [CS040X_RT04]   [firmware:0x43,major:0x1,minor:0x43]----5\n\n\ 
