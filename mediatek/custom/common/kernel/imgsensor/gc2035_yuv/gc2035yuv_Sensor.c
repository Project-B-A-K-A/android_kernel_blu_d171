...
kal_uint8 out_buff[2];
    ...
    out_buff[0] = addr;
    out_buff[1] = para;
printk("sym GC2035_write_cmos_sensor\n");
							 ...
							 UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	printk("sym GC2035FeatureControl  FeatureId=%d\n",FeatureId);
	switch (FeatureId)
	{
...
UINT32 GC2035_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
	...
	printk("sym GC2035_YUV_SensorInit\n");
	if (pfFunc!=NULL)
