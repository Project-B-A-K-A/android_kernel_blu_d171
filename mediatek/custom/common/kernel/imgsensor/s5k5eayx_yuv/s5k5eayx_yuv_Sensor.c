...
//AE Target    
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x004a);    //sym add ae diangdu + 6  //0x3a 0x32
   ...
   switch (para)
	{
		...
		case MEFFECT_SEPIAGREEN:		
		{
			...
			S5K5EAYX_write_cmos_sensor(0x0028,0x2000);					 
			S5K5EAYX_write_cmos_sensor(0x002A,0x0276);					 
			S5K5EAYX_write_cmos_sensor(0x0F12,0x0007);	//REG_TC_GP_SpecialEffects 	//08
	    }     
			break;        
		case MEFFECT_MONO:			
		{
...
//			S5K5EAYX_write_cmos_sensor(0x0F12, 0x0777);
			...
			S5K5EAYX_write_cmos_sensor(0x0F12, 0x0740); //Reg_sf_user_Rgain    //0x0740 //0800
			S5K5EAYX_write_cmos_sensor(0x0F12, 0x0001); //Reg_sf_user_RgainChanged
			S5K5EAYX_write_cmos_sensor(0x0F12, 0x0400); //0400Reg_sf_user_Ggain  //03d0
			S5K5EAYX_write_cmos_sensor(0x0F12, 0x0001); //Reg_sf_user_GgainChanged
			S5K5EAYX_write_cmos_sensor(0x0F12, 0x04C2); //0460Reg_sf_user_Bgain  //0X04D0
...
//			S5K5EAYX_write_cmos_sensor(0x0F12, 0x0777);
			S5K5EAYX_write_cmos_sensor(0x002A, 0x04F6); 
			S5K5EAYX_write_cmos_sensor(0x0F12, 0x04E1); //05E0Reg_sf_user_Rgain  //0x06c5
			S5K5EAYX_write_cmos_sensor(0x0F12, 0x0001); //Reg_sf_user_RgainChanged
			S5K5EAYX_write_cmos_sensor(0x0F12, 0x0400); //0400Reg_sf_user_Ggain
			S5K5EAYX_write_cmos_sensor(0x0F12, 0x0001); //Reg_sf_user_GgainChanged
			S5K5EAYX_write_cmos_sensor(0x0F12, 0x0652); //0530Reg_sf_user_Bgain  //0x04d3
			S5K5EAYX_write_cmos_sensor(0x0F12, 0x0001); //Reg_sf_user_BgainChanged
            }      
		    break;
