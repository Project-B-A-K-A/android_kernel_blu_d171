...
void OV5645MIPIInitialSetting(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x5184, 0x25);
	OV5645MIPI_write_cmos_sensor(0x5185, 0x24);
	OV5645MIPI_write_cmos_sensor(0x5186, 0x1b);
	OV5645MIPI_write_cmos_sensor(0x5187, 0x16);
	OV5645MIPI_write_cmos_sensor(0x5188, 0x1c);
  OV5645MIPI_write_cmos_sensor(0x5189, 0x75);
  OV5645MIPI_write_cmos_sensor(0x518a, 0x64);
  OV5645MIPI_write_cmos_sensor(0x518b, 0x9a);
  OV5645MIPI_write_cmos_sensor(0x518c, 0x88);
  OV5645MIPI_write_cmos_sensor(0x518d, 0x3a);
  OV5645MIPI_write_cmos_sensor(0x518e, 0x38);
  OV5645MIPI_write_cmos_sensor(0x518f, 0x57);
  OV5645MIPI_write_cmos_sensor(0x5190, 0x47);
  OV5645MIPI_write_cmos_sensor(0x5191, 0xf8);
  OV5645MIPI_write_cmos_sensor(0x5192, 0x4 );
  OV5645MIPI_write_cmos_sensor(0x5193, 0x70);
  OV5645MIPI_write_cmos_sensor(0x5194, 0xf0);
  ...
  OV5645MIPI_write_cmos_sensor(0x5196, 0x3 );
  OV5645MIPI_write_cmos_sensor(0x5197, 0x1 );
  OV5645MIPI_write_cmos_sensor(0x5198, 0x6 );
  OV5645MIPI_write_cmos_sensor(0x5199, 0x14);
  OV5645MIPI_write_cmos_sensor(0x519a, 0x4 );
  OV5645MIPI_write_cmos_sensor(0x519b, 0x0 );
  OV5645MIPI_write_cmos_sensor(0x519c, 0x4 );
  OV5645MIPI_write_cmos_sensor(0x519d, 0x66);
  OV5645MIPI_write_cmos_sensor(0x519e, 0x38);
  OV5645MIPI_write_cmos_sensor(0x5381, 0x1c);
  OV5645MIPI_write_cmos_sensor(0x5382, 0x5a);
  OV5645MIPI_write_cmos_sensor(0x5383, 0x6 );
  OV5645MIPI_write_cmos_sensor(0x5384, 0x9 );
  OV5645MIPI_write_cmos_sensor(0x5385, 0x72);
  OV5645MIPI_write_cmos_sensor(0x5386, 0x7b);
  OV5645MIPI_write_cmos_sensor(0x5387, 0x70);
  OV5645MIPI_write_cmos_sensor(0x5388, 0x62);
  OV5645MIPI_write_cmos_sensor(0x5389, 0xe );
  OV5645MIPI_write_cmos_sensor(0x538b, 0x98);
	OV5645MIPI_write_cmos_sensor(0x538a, 0x11);
   ...
   //spin_unlock(&ov5645mipi_drv_lock);
    ...
    {	
       case AE_EV_COMP_20:	                   
				...
				OV5645MIPI_write_cmos_sensor(0x3a10, 0x58);//	; AEC in L
				OV5645MIPI_write_cmos_sensor(0x3a11, 0xa0);//	; AEC out H
