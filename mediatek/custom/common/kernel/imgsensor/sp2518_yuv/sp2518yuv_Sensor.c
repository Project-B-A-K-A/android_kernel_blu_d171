 ...
 u8 SP2518_Initialize_from_T_Flash()
{
    ...
    fp = filp_open("/mnt/sdcard2/sp2518_sd", O_RDONLY , 0); 
    if (IS_ERR(fp)) { 
...
#define SP2518_MAX_GAIN_NOR   0xa0//a8
#define SP2518_MAX_GAIN_LOW  0xc8

//AE target
#define  SP2518_P0_0xf7  0x7c //0x78
#define  SP2518_P0_0xf8  0x70 //0x6c
#define  SP2518_P0_0xf9  0x78
#define  SP2518_P0_0xfa  0x6c
...
void SP2518_night_mode(kal_bool bEnable)
{
	...
	SENSORDB("Ronlus SP2518_night_mode\r\n");//亿新捷陈康sp2518      a8-10 创河田810 3p  
	//sensorlist.cpp kd_imagesensor.h add related files  
	#if 1//
	if (bEnable)/*night mode settings*/
	{			
				 SP2518_write_cmos_sensor(0xfd,0x00);
	           		SP2518_write_cmos_sensor(0x36,0x1c);//delete bad frame
				SP2518_set_param_wb(AWB_MODE_AUTO);
				msleep(260); // 0628 
				SP2518_CAM_Nightmode = 1;
				SP2518_write_cmos_sensor(0xfd,0x00);
				SP2518_write_cmos_sensor(0xb2,SP2518_LOWLIGHT_Y0ffset);
                            SP2518_write_cmos_sensor(0xfd,0x01);
                            SP2518_write_cmos_sensor(0x94,SP2518_MAX_GAIN_LOW);
                            SP2518_write_cmos_sensor(0xcc,SP2518_MAX_GAIN_LOW);
                            SP2518_write_cmos_sensor(0xcd,SP2518_MAX_GAIN_LOW);
	...
	else /*normal mode settings*/
	{
			...
			SP2518_write_cmos_sensor(0xfd,0x00);
			SP2518_write_cmos_sensor(0x36,0x00);//delete bad frame
		SENSORDB("Ronlus normal mode\r\n");
				SP2518_CAM_Nightmode = 0;
				SP2518_write_cmos_sensor(0xfd,0x00);
				SP2518_write_cmos_sensor(0xb2,SP2518_NORMAL_Y0ffset);
	                     SP2518_write_cmos_sensor(0xfd,0x01);
                            SP2518_write_cmos_sensor(0x94,SP2518_MAX_GAIN_NOR);
                            SP2518_write_cmos_sensor(0xcc,SP2518_MAX_GAIN_NOR); 
                            SP2518_write_cmos_sensor(0xcd,SP2518_MAX_GAIN_NOR);			
        if (SP2518_MPEG4_encode_mode == KAL_TRUE) 
		{
			...
			if(SP2518_CAM_BANDING_50HZ == KAL_TRUE)/*video normal mode 50hz*/
			{
				...
				//capture preview daylight 48M 50hz fix 9FPS maxgain   
					  SP2518_write_cmos_sensor(0xfd,0x00);
					  SP2518_write_cmos_sensor(0x03,0x04);
					  SP2518_write_cmos_sensor(0x04,0x92);
					  SP2518_write_cmos_sensor(0x09,0x00);
					  SP2518_write_cmos_sensor(0x0a,0x64); 
...

{
	...
	SP2518_write_cmos_sensor(0x1e,0x11);//0x81
	...
	//SP2518_write_cmos_sensor(0x31,0x70);//mirror upside down zhengbowen modify form 0x10
	...
	SP2518_write_cmos_sensor(0xfd,0x01);
		SP2518_write_cmos_sensor(0x28,0xde);
		SP2518_write_cmos_sensor(0x29,0x9a);
	...
	SP2518_write_cmos_sensor(0xfd,0x01);
	SP2518_write_cmos_sensor(0x94,SP2518_MAX_GAIN_NOR);//f8
...
//Status
	...
	SP2518_write_cmos_sensor(0xcc,SP2518_MAX_GAIN_NOR);//f8;rpc low
	SP2518_write_cmos_sensor(0xcd,SP2518_MAX_GAIN_NOR);//rpc dummy
 ...
 SP2518_write_cmos_sensor(0xfd , 0x00);
	...
	SP2518_write_cmos_sensor(0xfd,0x01);
		...
		SP2518_write_cmos_sensor(0xfd,0x00);
		SP2518_write_cmos_sensor(0x57,0x02);//raw_dif_thr
		SP2518_write_cmos_sensor(0x58,0x04);//a
		SP2518_write_cmos_sensor(0x56,0x08);//a
		SP2518_write_cmos_sensor(0x59,0x10);
		//R\B通道间平滑
		SP2518_write_cmos_sensor(0x5a,0xe8);//raw_rb_fac_outdoor
		SP2518_write_cmos_sensor(0xc4,0xb8);//60raw_rb_fac_indoor
		SP2518_write_cmos_sensor(0x43,0x90);//40raw_rb_fac_dummy  
		SP2518_write_cmos_sensor(0xad,0x20);//raw_rb_fac_low  
		//Gr、Gb 通道内部平滑
		SP2518_write_cmos_sensor(0x4f,0xe8);//raw_gf_fac_outdoor
		SP2518_write_cmos_sensor(0xc3,0xb8);//60raw_gf_fac_indoor
		SP2518_write_cmos_sensor(0x3f,0x90);//40raw_gf_fac_dummy
		SP2518_write_cmos_sensor(0x42,0x20);//raw_gf_fac_low
		SP2518_write_cmos_sensor(0xc2,0x15);
		//Gr、Gb通道间平滑
		SP2518_write_cmos_sensor(0xb6,0xe8);//raw_gflt_fac_outdoor
		SP2518_write_cmos_sensor(0xb7,0xb0);//60raw_gflt_fac_normal
		SP2518_write_cmos_sensor(0xb8,0x60);//40raw_gflt_fac_dummy
		SP2518_write_cmos_sensor(0xb9,0x10);//raw_gflt_fac_low
		//Gr、Gb通道阈值
		SP2518_write_cmos_sensor(0xfd,0x01);
		SP2518_write_cmos_sensor(0x50,0x02);//raw_grgb_thr
		SP2518_write_cmos_sensor(0x51,0x08);
		SP2518_write_cmos_sensor(0x52,0x0a);
		SP2518_write_cmos_sensor(0x53,0x15);
		SP2518_write_cmos_sensor(0xfd,0x00);	
#else
	//raw filter
	SP2518_write_cmos_sensor(0xfd,0x01);
	SP2518_write_cmos_sensor(0xde,0x0f);
		...
		SP2518_write_cmos_sensor(0x56,0x0a);//a
		SP2518_write_cmos_sensor(0x59,0x10);
		//R\B通道间平滑
		SP2518_write_cmos_sensor(0x5a,0xe8);//raw_rb_fac_outdoor
		...
		//Gr、Gb通道阈值
		SP2518_write_cmos_sensor(0xfd,0x01);
		SP2518_write_cmos_sensor(0x50,0x04);//raw_grgb_thr
		SP2518_write_cmos_sensor(0x51,0x08);
	...
	SP2518_write_cmos_sensor(0x18,0x00);//20
	SP2518_write_cmos_sensor(0x19,0x00);//20
	...
	SP2518_write_cmos_sensor(0xa0,0x18);//0xa6//0xa6//0xbf
	SP2518_write_cmos_sensor(0xa1,0xda);//0xda//0xda0xda
	SP2518_write_cmos_sensor(0xa2,0x8e);//0x00//0x000xe7
	SP2518_write_cmos_sensor(0xa3,0x2c);//0x2c//0x2c0x2c
	SP2518_write_cmos_sensor(0xa4,0x4a);//0x8b//0x640x64
	SP2518_write_cmos_sensor(0xa5,0x09);//0xc8//0xf00xf0
	SP2518_write_cmos_sensor(0xa6,0x00);//0x00//0x000x00
	SP2518_write_cmos_sensor(0xa7,0xb5);//0xce//0xce0xb5
	SP2518_write_cmos_sensor(0xa8,0xcb);//0xb2//0xb20xcb
	SP2518_write_cmos_sensor(0xa9,0x3d);//0x0c//0x0c0x3c
	SP2518_write_cmos_sensor(0xaa,0x00);//0x30//0x300x30
	SP2518_write_cmos_sensor(0xab,0x0c);//0x0c//0x0c0x0c
#endif
#if 1
		SP2518_write_cmos_sensor(0xac,0x99);//b8 
		SP2518_write_cmos_sensor(0xad,0xda);//d5
		SP2518_write_cmos_sensor(0xae,0x0c);//f2
		SP2518_write_cmos_sensor(0xaf,0xfa);//e8
		SP2518_write_cmos_sensor(0xb0,0xa0);//95
		SP2518_write_cmos_sensor(0xb1,0xe7);//03
		SP2518_write_cmos_sensor(0xb2,0x00);//f2
		SP2518_write_cmos_sensor(0xb3,0xda);//c4
		SP2518_write_cmos_sensor(0xb4,0xa6);//ca
	...
	SP2518_write_cmos_sensor(0xc1,0xf0);
		...
		SP2518_write_cmos_sensor(0xd3,0x90);
		SP2518_write_cmos_sensor(0xd4,0x90);
		SP2518_write_cmos_sensor(0xd6,0x68);
		SP2518_write_cmos_sensor(0xd7,0x68);
		SP2518_write_cmos_sensor(0xd8,0x90);
...
/*
	...
	SP2518_write_cmos_sensor(0x8e,0x25);//3//a;25
...
//gamma2                   
	...
	//HEQ
	SP2518_write_cmos_sensor(0xfd,0x00);//
	SP2518_write_cmos_sensor(0xdd,0x78);//0x80//0x80 sp_cm20130729
	SP2518_write_cmos_sensor(0xde,0xb8);//98 b0
	SP2518_write_cmos_sensor(0xdf,0x80);//
	//Ytarget 
#if	0
	SP2518_write_cmos_sensor(0xfd,0x00);// 
	SP2518_write_cmos_sensor(0xec,0x70);//6a
	SP2518_write_cmos_sensor(0xed,0x86);//7c
	SP2518_write_cmos_sensor(0xee,0x70);//65
	SP2518_write_cmos_sensor(0xef,0x86);//78
	SP2518_write_cmos_sensor(0xf7,0x80);//78
	SP2518_write_cmos_sensor(0xf8,0x74);//6e
	SP2518_write_cmos_sensor(0xf9,0x80);//74
	SP2518_write_cmos_sensor(0xfa,0x74);//6a 
#else
	/*SP2518_write_cmos_sensor(0xfd,0x00);// 
	...
	SP2518_write_cmos_sensor(0xe5,0x08);//10
	SP2518_write_cmos_sensor(0xe7,0x08);//10
		SP2518_write_cmos_sensor(0xe8,0x38);
		SP2518_write_cmos_sensor(0xec,0x38);
	...
	SP2518_write_cmos_sensor(0xfd,0x00);
	#if defined(PROJECT_CUSTOMER_J221) || defined(PROJECT_CUSTOMER_J202)
	SP2518_write_cmos_sensor(0x31,0x70);//zheng modify form 0x10//0x70 test
	#else
	SP2518_write_cmos_sensor(0x31,0x10);//zheng modify form 0x10
	#endif
	SP2518_write_cmos_sensor(0x35,0x40);    
	SP2518_write_cmos_sensor(0x32,0x0d);
	SP2518_write_cmos_sensor(0x33,0xcf);//cf
	SP2518_write_cmos_sensor(0x34,0x7f);// 3f
	SP2518_write_cmos_sensor(0xe7,0x00);

      SP2518_config_window(WINDOW_SIZE_UXGA);//WINDOW_SIZE_SVGA;WINDOW_SIZE_VGA;
   //  msleep(300);
}
}
        ...
        MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    ...
    pSensorInfo->PreviewDelayFrame = 8; //  3
