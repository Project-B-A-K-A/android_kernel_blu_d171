...
const TABLE_FOR_SPECIAL_LID g_new_nvram_lid[] = 
{
	...
	{ AP_CFG_REEB_PRODUCT_NEW_INFO_LID, 1024*1024, 1024*1024  }, //DELL-1046 add by silongjun
#else
	{ AP_CFG_REEB_PRODUCT_INFO_LID, 0, 256 * 1024 },
	{ AP_CFG_REEB_PRODUCT_NEW_INFO_LID, 256*1024, 256*1024  }, //DELL-1046 add by silongjun
#endif
