...
CUSTOM_BUILD_VERNO =
# add for internal verno customization by jinhaijian
CUSTOM_INTERNAL_BUILD_VERNO =

#add BUG_ID:DDLELTCLW-1 daizhiyi 20130618 (start)
CUSTOM_BUILD_HARDWARE_VERNO =
#add BUG_ID:DDLELTCLW-1 daizhiyi 20130618 (end)
...
AUTO_ADD_GLOBAL_DEFINE_BY_NAME_VALUE = MTK_NFC_SE_NUM MTK_SIM1_SOCKET_TYPE MTK_SIM2_SOCKET_TYPE CUSTOM_KERNEL_MAIN2_IMGSENSOR CUSTOM_KERNEL_SSW MTK_LCM_PHYSICAL_ROTATION LCM_WIDTH MTK_SHARE_MODEM_SUPPORT MTK_SINGLE_3DSHOT_SUPPORT MTK_EXTERNAL_MODEM_SLOT EMMC_CHIP MTK_NEON_SUPPORT MTK_SHARE_MODEM_CURRENT LCM_HEIGHT MTK_TOUCH_PHYSICAL_ROTATION_RELATIVE_TO_LCM RGK_INTERNAL_SD_VOLUME_NAME

#================================================================================
MTK_PRODUCT_LOCALES=en_US es_ES zh_CN zh_TW ru_RU pt_BR fr_FR de_DE tr_TR it_IT in_ID ms_MY vi_VN ar_EG  th_TH  pt_PT   nl_NL el_GR hu_HU tl_PH ro_RO cs_CZ bn_IN hdpi
...
#CUSTOM_HAL_MATV=
CUSTOM_HAL_MSENSORLIB=mmc328x akm8975 ami304 yamaha530 mag3110 akmd8963 bmm050 mc6420 mmc3416x s62xd lsm303md hscdtd006 qmc5983 akmd09911
...
# To enable RGK_OTA FEATURE guocl add
RGK_OTA_SUPPORT = yes

# ADD for TCL CUSTOM CHANGES
RGK_FOR_TCL_CUSTOM = no
RGK_FOR_CUCC_CUSTOMER = no
#add BUG_ID:DELB-355 zhushengui 20130628 (start)
RGK_MAXIMUS_SUPPORT = no
#add BUG_ID:DELB-355 zhushengui 20130628 (end)
#Add, DELB-427, zhushengui, 20130708, start
RGK_POSITIVO_SUPPORT = no
#Add, DELB-427, zhushengui, 20130708, end
...
RGK_ONLY_SHOW_ONE_SML_LOCK_SCREEN = no
RGK_SML_LOCK_SIM2_DEPEND_ON_SIM1 = no
#add by chenweihua 20131025 (end)
#add by liuxianbang for ota test  20131113 (start)
RGK_OTA_PROJECT =
#add by liuxianbang for oat test  20131113 (end)
#add by DaiHongyi for feature  auto change message size limit  20131113 (start)
RGK_AUTO_CHANGE_MESSAGE_SIZE_LIMIT = no
#add by DaiHongyi for feature  auto change message size limit 20131113 (end)
#add by liuxianbang for DYLJ-489 20131118  (start)
RGK_SMS_ENCODING_ES = no
#add by liuxianbang for DYLJ-489 20131118  (end)
#add  BUG_ID:DYLJ-559  zhanwenyu  20131126(start)
RGK_BT_FTP_MOUNT_PATH = no
#add  BUG_ID:DYLJ-559  zhanwenyu  20131126(end)
#add by liuxianbang for MDEYW-603 20140107  (start)
RGK_SMS_ENCODING_LOSSY = no
#add by liuxianbang for MDEYW-603 20140107  (end)
