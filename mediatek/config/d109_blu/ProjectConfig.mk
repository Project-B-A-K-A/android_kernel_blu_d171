...
CUSTOM_BUILD_VERNO=BLU-D171a-V08-GENERIC
#add by jinhaijian for internal bld number
CUSTOM_INTERNAL_BUILD_VERNO=D109_BLU_B1A_V2.5.6_S1118
...
CUSTOM_HAL_IMGSENSOR=gc2035_pl_yuv sp2518_yuv s5k8aayx_yuv sp0a19_yuv gc0329_yuv
...
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR=sp2518_yuv
...
CUSTOM_HAL_MAIN_IMGSENSOR=gc2035_pl_yuv
...
#modify tianchunming 20130719 BUG_id:DYLJ-68 begin
#CUSTOM_KERNEL_ALSPS=stk3x1x
CUSTOM_KERNEL_ALSPS=
#modify tianchunming 20130719 BUG_id:DYLJ-68 end
...
CUSTOM_KERNEL_IMGSENSOR=gc2035_pl_yuv sp2518_yuv s5k8aayx_yuv sp0a19_yuv gc0329_yuv
...
CUSTOM_LK_LCM=nt35310_dsi_cmd_djn_hvga ili9488_dsi_vdo_azet_hvga
...
# Those option is for baidu Location
# All 72 project is it should be set as "no".
...
# enable the data connection switching notification dailog
MTK_DATADIALOG_APP=no

# yes: enable DataReg solution
# no:  disable DataReg solution
MTK_DATAREG_APP=no
...
# app will decide whether to show effect selection with the value of MTK_LIVE_EFFECT_ENABLE.
...
# This option is for memory preserved mode feature
#  When the project is on 72 platform, it should be set as "yes", otherwise "no"
#  When MTK_MEM_PRESERVED_MODE_ENABLE = yes,will will build in memory preserved mode in preloader and LK.
...
# yes, the UI components are visiable to end users in Settings UI.
#  no, the UI components are invisiable to end users in Settings UI.
...
# if MTK_RSDM_APP is yes,need to build "rsdm.apk"
MTK_RSDM_APP=no
...
# Todos is a new feature only for CMCC proejcts. With this apk, users could create, edit and view their To-do things.
MTK_TODOS_APP=yes
...
# To simplify NAND OTP enable procedue.yes: Enable NAND OTP function support,no: Disable NAND OTP function support
NAND_OTP_SUPPORT=no
...
# TELEPHONY_DFOSET_VALUE describe what features in this DFO feature set.
...
CUSTOM_MODEM=d109_b1a_hspa_gemini
...
CUSTOM_KERNEL_LCM=nt35310_dsi_cmd_djn_hvga ili9488_dsi_vdo_azet_hvga

# To choose uboot LCM driver name
CUSTOM_UBOOT_LCM=nt35310_dsi_cmd_djn_hvga ili9488_dsi_vdo_azet_hvga
...
#modify bug_id:MDEYW-16 shidongdong 20130703 start
#MTK_PRODUCT_LOCALES=en_US es_ES zh_CN zh_TW ru_RU pt_BR fr_FR de_DE tr_TR it_IT in_ID ms_MY vi_VN ar_EG  th_TH mdpi hdpi -sw600dp -sw720dp  pt_PT   nl_NL el_GR hu_HU tl_PH ro_RO cs_CZ iw_IL my_MM km_KH ko_KR
MTK_PRODUCT_LOCALES=en_US es_ES pt_BR fr_FR nl_NL zh_CN de_DE hu_HU cs_CZ ar_EG pl_PL fa_IR hdpi mdpi -sw600dp -sw720dp
#modify bug_id:MDEYW-16 shidongdong 20130703 end
# mATV framework customzation folder:  mediatek/custom/common/hal/matv/
CUSTOM_HAL_MATV=

# mATV kernel customzation folder: mediatek/custom/common/kernel/matv/mt5192 mediatek/custom/common/kernel/matv/mt5193
CUSTOM_KERNEL_MATV=
...
RGK_COOLPAD_SUPPORT = no
#add BUG_ID:JELY-2 daizhiyi 20130416 (end)

#add BUG_ID:DYLJ-8 tianchunming 20130711 (start)
RGK_DUALSIMIMEI_SUPPORT = yes
#add BUG_ID:DYLJ-8 tianchunming 20130711 (end)

#add for TP upgrade support choose 20130521 by xiaoanxiang(start)
RGK_TP_AUTO_UPGRADE_SUPPORT = no
#add  (end)

#add for TP upgrade support choose 20130521 by xiaoanxiang(start)
RGK_TP_NODE_UPGRAER_SUPPORT = yes
#add  (end)
#add for TP upgrade  node write permission 20130522 by xiaoanxiang(start)
RGK_TP_NODE_UPGRAER_WRITE_PERMISSION_OPEN = no
#add  (end)
#add for flash support JEEY-247 20130527 by liuxianbang (start)
RGK_FLASH_SUPPORT = no
#add  (end)
MTK_PROJECT_CUSTOMER = PROJECT_CUSTOMER_D109
#add BUG_ID:DELB-213 liangyulong 20130618 (start)
RGK_OTA_SUPPORT = no
#add BUG_ID:DELB-213 liangyulong 20130618 (end)

#add for fota xianbangliu 20130703
RGK_OTA_DELETE_SETTINGS_ABOUT_SYSTEMUPDATES = yes
#adupsfota start
ADUPS_FOTA_SUPPORT = yes
ADUPS_FOTA_WITH_ICON = yes
#adupsfota end
#add BUG_ID:MDEYW-28 des:When there is wifi available,Play tone. liangyulong 20130702(start)
RGK_IS_WIFISOUND = yes
#add BUG_ID:MDEYW-28 liangyulong 20130702(end)
#add BUG_ID:MDEYW-33 liuxianbang 20130703(start)
RGK_BUILDTIME_SUPPORT = yes
#add BUG_ID:MDEYW-33 liuxianbang 20130703(start)
#add for project blu by liuxianbang 20130704(start)
PROJECT_BLU = yes
#add for project blu by liuxianbang 20130704(end)
#add for rf by zhoulidong(start)
PROJECT_BLU_D109 = yes
#add for rf by zhoulidong(end)
RGK_IP_DIAL = no

#add for blu mtp name liuxianbang 20130806 (start)
RGK_PRODUCT_STRING =2
#add for blu mtp name liuxianbang 20130806 (end)
#add by liuxianbang for ota test  20131113 (start)
RGK_OTA_PROJECT =d109_blu
#add by liuxianbang for oat test  20131113 (end)
