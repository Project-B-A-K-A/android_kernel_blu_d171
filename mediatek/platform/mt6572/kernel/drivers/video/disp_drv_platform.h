...
#if defined(PROJECT_BLU_D109) || defined(RGK_PROJECT_DSI_SSC)

#else
#define MTK_MIPI_DSI_SSC    // MIPI DSI SSC feature support
#endif
#define MTK_TRIPLE_FRAMEBUFFER_SUPPORT    // turn on triple buffer control
